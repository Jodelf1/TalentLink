...
<section class="sidebar flex col j-between">
    ...
    <nav class="sidebar-menu">
        ...
        <a class="notification-container relative" id="notification-button">
            ...
            <a href="/empresas/perfil" class="user-card candidato-card">
            ...
            <a href="/empresas" class="sidebar-link <?= $currentUrl == '/empresas' ? 'ativo' : '' ?> "><i class="fa-solid fa-house"></i> Página inicial</a>
